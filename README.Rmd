...
triangulaR is a package for calculating hybrid indices, heterozygosity, and building triangle plots from genomic data

## Installation

You can install the development version of triangulaR from [GitHub](https://github.com/) with:
