...
<img src="../man/figures/punnett_squares.png" align="left" alt="" width="280" /> Another way to think about the expected genotypes in hybrid offspring is with Punnett squares. The Punnett square on the top shows the expected proportion of genotypes at AIMs across the genome in an F1. 
